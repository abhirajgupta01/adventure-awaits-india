        ...
        <div className="state-category-page">
          <div className="category-navigation">
            ...
            <div className="category-tabs">
              <Link to={`/state/${stateId}/hotels`} className="category-tab active">
              ...
              <Link to={`/state/${stateId}/attractions`} className="category-tab">
          ...
          <div className="category-banner hotel-banner">
            <div className="banner-content">
              <h1><i className="fas fa-hotel"></i> Hotels in {stateInfo.name}</h1>
              <p>Find comfortable accommodations for your stay in {stateInfo.name}</p>
            </div>
          </div>
