        ...
        <div className="state-category-page">
          <div className="category-navigation">
            ...
            <div className="category-tabs">
              ...
              <Link to={`/state/${stateId}/restaurants`} className="category-tab active">
          ...
          <div className="category-banner restaurant-banner">
            <div className="banner-content">
              <h1><i className="fas fa-utensils"></i> Restaurants in {stateInfo.name}</h1>
